...
<c:if test="${not empty message}">
  <div class="section ${success ? '' : 'error'} message">
    ${message}
...
<script>
  (function() {
    var profileAmount = ${fn:length(profiles)};
    if (profileAmount > 3) {
      document.forms["profile-form"]["profile"].size = profileAmount;
    }
    ...
    if ('profile-form' in document.forms) {
