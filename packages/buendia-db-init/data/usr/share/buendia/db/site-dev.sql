...
INSERT INTO location (name, creator, date_created, uuid) VALUES
    ('Facility', @admin, NOW(), 'e20f2bf8-8650-11e4-9aee-040ccecfdba4')
...
INSERT INTO location (name, creator, date_created, uuid, parent_location) VALUES
    ...
    ('S3', @admin, NOW(), 'c7a69e19-8650-11e4-9cc2-040ccecfdba4', @suspect_id),
    ('S4', @admin, NOW(), 'c87ad5ab-8650-11e4-afd6-040ccecfdba4', @suspect_id),
    ...
    ('P3', @admin, NOW(), 'c89d00a1-8650-11e4-a82d-040ccecfdba4', @probable_id),
    ('P4', @admin, NOW(), 'c8ba4385-8650-11e4-8641-040ccecfdba4', @probable_id),
    ...
    ('C9', @admin, NOW(), 'c8d6607a-8650-11e4-9dfb-040ccecfdba4', @confirmed_id),
    ('C10', @admin, NOW(), 'c8f5a8d7-8650-11e4-81c0-040ccecfdba4', @confirmed_id)
    ON DUPLICATE KEY UPDATE uuid=uuid;
